<template>
  <div class="cdc-container" :style="placementStyles.container">
    <div class="cdc" ref="donut" :style="donutStyles">
      <donut-sections v-on="sectionListeners" :sections="donutSections" :start-angle="startAngle"></donut-sections>
    ...
    <slot name="legend">
      <div class="cdc-legend" v-if="hasLegend" :style="placementStyles.legend">
        <span
          ...
          :title="item.percent"
        >
          <span class="cdc-legend-item-color" :style="item.styles">{{ getValue(idx) }}</span>
